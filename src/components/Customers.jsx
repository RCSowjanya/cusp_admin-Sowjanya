...
const Customers = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("Approved"); // Default dropdown option
  ...
  return (
    <div className="">
      <div className="flex gap-3 max-[1100px]:flex-col">
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A] max-[1100px]:w-full rounded-lg pb-6 ">
          <div className="flex justify-between mb-4 bg-[#F4F4FF] py-5 px-3">
            <p className="text-[1.2rem] font-[600] text-[#4348BD]">All Users</p>
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A]  max-[1100px]:w-full  rounded-lg  ">
          <div className="flex justify-between mb-4 bg-[#F4F4FF] px-5 py-3">
            <div className="">
              <h5 className=" text-[14px] font-[500]">Name</h5>
              <p className="text-[1.2rem] text-[#4348BD] font-[500]">Rounak</p>
            </div>
            <div className="">
              <h5 className="text-[14px] font-[500]">Email</h5>
