    ...
    <div className="">
      <div className="flex gap-3 max-[1100px]:flex-col">
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A] max-[1100px]:w-full rounded-lg ">
          <div className="flex justify-between mb-4 bg-[#F4F4FF] py-5 px-2">
            <p className="text-[1.2rem] font-[600] text-[#000]">All Leads</p>
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A] max-[1100px]:w-full rounded-lg ">
          <div className="flex justify-between mb-4 bg-blue-100 px-5 py-3">
            <div className="">
              <h5 className=" text-[14px] font-[500]">Amazon Solar</h5>
              <p className="text-[1.2rem] text-[#4348BD] font-[500]">Solar</p>
            </div>

            <div className="flex gap-2">
              <div>
                <a href="#">
                  <button className="border-red-400 border py-2 px-4 text-red-400 rounded-md">
                    Reject
                  </button>
                </a>
              </div>
              <div>
                <a href="#">
                  <button className="bg-[#0BB68D] border py-2 px-4 text-white rounded-md">
                    Approve
                  </button>
                </a>
              </div>
